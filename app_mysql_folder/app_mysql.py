...
app = Flask(__name__)
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:pass%40word1@localhost/banking'
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:pass%40word1@host.docker.internal/banking'
